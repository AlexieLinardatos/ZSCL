#!/bin/bash
#SBATCH --job-name=10t_replay_nolora_10k
...
# 10-task: ZSCL + Replay (no LoRA), budget=10k
# Tests whether doubling replay budget beats replay_no_lora (85.33%)
