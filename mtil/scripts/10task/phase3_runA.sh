...
# Run A: Phase 3 with lambda_replay_teacher_distill=0.1 (down from 0.5)
# Tests whether lower teacher distillation weight fixes the overconstrained optimization
...
SAVE_PATH="ckpt/10task/phase3_runA"
mkdir -p "${SAVE_PATH}"
...
echo "[`date`] Starting Run A: Phase 3 with lambda=0.1"
