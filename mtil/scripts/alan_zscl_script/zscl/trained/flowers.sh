...
SAVE_PATH="ckpt/clean/gradient_zscl/trained/DTD_trained/MNIST_trained/EuroSAT_trained/Flowers_trained"
PREV_LOAD_PATH="ckpt/clean/gradient_zscl/trained/DTD_trained/MNIST_trained/EuroSAT_trained/EuroSAT.pth"
PREV_GRADIENT_PATH="ckpt/clean/gradient_zscl/trained/DTD_trained/MNIST_trained/EuroSAT_trained/grad_EuroSAT.pth"
