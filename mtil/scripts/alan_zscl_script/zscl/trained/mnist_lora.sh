#!/bin/bash
#SBATCH --job-name=zscl_mnist_lora
...
SAVE_PATH="ckpt/clean/5000_iter/zscl/lora/trained/DTD_trained/MNIST_trained"
PREV_LOAD_PATH="ckpt/clean/5000_iter/zscl/lora/trained/DTD_trained/DTD.pth"
