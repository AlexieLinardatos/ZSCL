#!/bin/bash
#SBATCH --job-name=p3_base_flowers
...
SAVE_PATH="ckpt/phase3/baseline/DTD_trained/MNIST_trained/EuroSAT_trained/Flowers_trained"
PREV_LOAD_PATH="ckpt/phase3/baseline/DTD_trained/MNIST_trained/EuroSAT_trained/EuroSAT.pth"
mkdir -p "${SAVE_PATH}"
