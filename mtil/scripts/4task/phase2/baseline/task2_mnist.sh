...
SAVE_PATH="ckpt/phase2.1/baseline/DTD_trained/MNIST_trained"
PREV_LOAD_PATH="ckpt/phase2.1/baseline/DTD_trained/DTD.pth"
mkdir -p "${SAVE_PATH}"
...
echo "[`date`] Training MNIST (task 2 of 4)"
