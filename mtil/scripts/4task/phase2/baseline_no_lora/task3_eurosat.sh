#!/bin/bash
#SBATCH --job-name=p2_nolora_eurosat
...
SAVE_PATH="ckpt/phase2.1/baseline_no_lora/DTD_trained/MNIST_trained/EuroSAT_trained"
PREV_LOAD_PATH="ckpt/phase2.1/baseline_no_lora/DTD_trained/MNIST_trained/MNIST.pth"
mkdir -p "${SAVE_PATH}"
...
echo "[`date`] Training EuroSAT (task 3 of 4, no LoRA)"
...
echo "[`date`] Done. Checkpoint: ${SAVE_PATH}/EuroSAT.pth"
