#!/bin/bash
#SBATCH --job-name=p2_nolora_mnist
...
SAVE_PATH="ckpt/phase2.1/baseline_no_lora/DTD_trained/MNIST_trained"
PREV_LOAD_PATH="ckpt/phase2.1/baseline_no_lora/DTD_trained/DTD.pth"
mkdir -p "${SAVE_PATH}"
...
echo "[`date`] Training MNIST (task 2 of 4, no LoRA)"
...
echo "[`date`] Done. Checkpoint: ${SAVE_PATH}/MNIST.pth"
