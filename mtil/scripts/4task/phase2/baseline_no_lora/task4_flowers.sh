#!/bin/bash
#SBATCH --job-name=p2_nolora_flowers
...
SAVE_PATH="ckpt/phase2.1/baseline_no_lora/DTD_trained/MNIST_trained/EuroSAT_trained/Flowers_trained"
PREV_LOAD_PATH="ckpt/phase2.1/baseline_no_lora/DTD_trained/MNIST_trained/EuroSAT_trained/EuroSAT.pth"
mkdir -p "${SAVE_PATH}"
...
echo "[`date`] Training Flowers (task 4 of 4, no LoRA)"
