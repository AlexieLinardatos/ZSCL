#!/bin/bash
#SBATCH --job-name=11t_ext1_coverage
...
# Replay-buffer extension 1: TRANSFER-COVERAGE SELECTION
# Same config as phase3_no_lora_11t_v4.sh, but the replay buffer selects
# exemplars by global k-center / farthest-point sampling in frozen CLIP
# feature space (1-per-class floor) instead of uniform random. Tiles the
# embedding manifold broadly so the distillation branch anchors more of
# feature space -> better zero-shot transfer retention.
