#!/bin/bash
#SBATCH --job-name=11t_exem_herding
...
# Exemplar selection ablation: HERDING
# Same config as phase3_no_lora_11t_v4.sh, but the replay buffer picks
# exemplars via iCaRL herding (greedy: sample closest to running class mean)
...
SAVE_PATH="ckpt/11task/phase3_exemplar_herding"
mkdir -p "${SAVE_PATH}"
