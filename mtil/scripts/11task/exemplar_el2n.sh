...
# Exemplar selection ablation: EL2N
# Same config as phase3_no_lora_11t_v4.sh, but the replay buffer picks
# the hardest examples (top-k by ||softmax(logits) - onehot(y)||_2)
# inside each class.
...
SAVE_PATH="ckpt/11task/phase3_exemplar_el2n"
mkdir -p "${SAVE_PATH}"
