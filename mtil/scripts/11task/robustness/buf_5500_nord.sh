...
# Buffer sensitivity: ZSCL + proportional replay, NO RD, at B=5500.
# Baseline pair for buf_5500_exrd — isolates RD's Transfer benefit at mid budget.
