...
# Buffer sensitivity: ZSCL + proportional replay, NO RD, at B=3000.
# Baseline pair for buf_3k_exrd — isolates RD's Transfer benefit at mid budget.
