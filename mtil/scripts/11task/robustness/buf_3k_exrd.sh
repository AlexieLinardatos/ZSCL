...
# Buffer sensitivity: ExRD (lambda=0.3) at B=3000 (~2.5 exemplars/class).
# Identical to v4 except replay_budget 11000 -> 3000.
# Matches GIFT's second reported budget for direct comparison.
