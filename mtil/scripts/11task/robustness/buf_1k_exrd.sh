...
# Buffer sensitivity: ExRD (lambda=0.3) at B=1000 (~0.8 exemplars/class).
# Identical to v4 except replay_budget 11000 -> 1000.
# Matches GIFT's smallest reported budget for direct comparison.
