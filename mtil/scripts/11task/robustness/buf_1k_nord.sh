...
# Buffer sensitivity: ZSCL + proportional replay, NO RD, at B=1000.
# Baseline pair for buf_1k_exrd — isolates RD's Transfer benefit at low budget.
