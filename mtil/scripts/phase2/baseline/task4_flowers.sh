...
SAVE_PATH="ckpt/phase2/baseline/DTD_trained/MNIST_trained/EuroSAT_trained/Flowers_trained"
PREV_LOAD_PATH="ckpt/phase2/baseline/DTD_trained/MNIST_trained/EuroSAT_trained/EuroSAT.pth"
mkdir -p "${SAVE_PATH}"
