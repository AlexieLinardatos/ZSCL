...
def load_base_model(args):
    ...
    # Apply LoRA before loading checkpoints to allow loading LoRA weights if present.
...
def setup_lora(args, model):
    ...
    return apply_lora_if_enabled(args, model)
...
def custom_finetune(args, replay_buffer=None):
    ...
    # LoRA is applied during base model load (see load_base_model).
