#!/bin/bash
#SBATCH --job-name=p3_base_eurosat
...
SAVE_PATH="ckpt/phase3/baseline/DTD_trained/MNIST_trained/EuroSAT_trained"
PREV_LOAD_PATH="ckpt/phase3/baseline/DTD_trained/MNIST_trained/MNIST.pth"
mkdir -p "${SAVE_PATH}"
...
echo "[`date`] Training EuroSAT (task 3 of 4)"
